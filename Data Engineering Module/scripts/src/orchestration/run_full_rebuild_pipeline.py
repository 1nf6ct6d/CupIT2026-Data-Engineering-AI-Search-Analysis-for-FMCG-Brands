...
def reset_working_tables():
    conn = get_connection()
    cur = conn.cursor()

    cur.execute("""
    TRUNCATE TABLE
        dwh.fact_ai_brand_mentions,
        dwh.fact_ai_sources,
        dwh.fact_ai_answers,
        dwh.fact_brand_mentions,
        dwh.fact_search_results,
        stage.ai_sources,
        stage.ai_answers,
        stage.search_results,
        raw.ai_responses,
        raw.search_responses
    ...
    print("Working tables truncated.")
...
def main():
    ...
    print("\nFULL REBUILD PIPELINE COMPLETED SUCCESSFULLY")
